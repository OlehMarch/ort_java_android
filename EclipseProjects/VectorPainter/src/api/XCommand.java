...
public class XCommand {
	...
	private PropertiesPanel property;
	...
	public XCommand(TabbedPanel tab, PropertiesPanel property) {
		super();
	...
	public class ActionProperties implements ICommand {

		@Override
		public void actionPerformed(ActionEvent e) {
			
			if (property.isVisible()){
				property.hideProperty();
			}
			else{
				property.showProperty(tab.getActiveCanvas().getInFocusFigure().getBounds());
			}
		}
	}
}

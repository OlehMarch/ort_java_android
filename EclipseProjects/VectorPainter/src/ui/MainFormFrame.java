...
public class MainFormFrame extends JFrame {
	...
	public MainFormFrame(String name, Rectangle r) {
		...
		tab = new TabbedPanel(new Rectangle(r.x, r.y - 15, r.width - 300, r.height - r.y * 3), statusBar);
		PropertiesPanel properties = new PropertiesPanel(new Rectangle(r.x + r.width - 300, r.y + 7, 150, 500));
		cmd = new XCommand(tab, properties);
		properties.setListeners(cmd);

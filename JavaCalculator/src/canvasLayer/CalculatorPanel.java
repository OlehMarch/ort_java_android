...
public class CalculatorPanel extends JPanel
{
	...
	private void initComponents()
	{
		...
		textField.setBounds(X_START, Y_START + (row * 50), 170, 40);
		
		buttonEqual = new JButton("=");
		buttonEqual.setBounds(X_START + 180, Y_START + (row++ * 45), 50, 40);
		
		button7 = new JButton("1");
		button7.setBounds(X_START, Y_START + (row * 50), 50, 30);
		
		button8 = new JButton("2");
		button8.setBounds(X_START + 60, Y_START + (row * 50), 50, 30);
		
		button9 = new JButton("3");
		button9.setBounds(X_START + 120, Y_START + (row * 50), 50, 30);
		
		buttonDiv = new JButton("/");
		buttonDiv.setBounds(X_START + 180, Y_START + (row++ * 50), 50, 30);
		
		button4 = new JButton("4");
		button4.setBounds(X_START, Y_START + (row * 50), 50, 30);
		
		button5 = new JButton("5");
		button5.setBounds(X_START + 60, Y_START + (row * 50), 50, 30);
		
		button6 = new JButton("6");
		button6.setBounds(X_START + 120, Y_START + (row * 50), 50, 30);
		
		buttonMul = new JButton("X");
		buttonMul.setBounds(X_START + 180, Y_START + (row++ * 50), 50, 30);
		
		button1 = new JButton("7");
		button1.setBounds(X_START, Y_START + (row * 50), 50, 30);
		
		button2 = new JButton("8");
		button2.setBounds(X_START + 60, Y_START + (row * 50), 50, 30);
		
		button3 = new JButton("9");
		button3.setBounds(X_START + 120, Y_START + (row * 50), 50, 30);
		
		buttonSub = new JButton("-");
		buttonSub.setBounds(X_START + 180, Y_START + (row++ * 50), 50, 30);
		
		button0 = new JButton("0");
		button0.setBounds(X_START, Y_START + (row * 50), 170, 30);
		
		buttonAdd = new JButton("+");
		buttonAdd.setBounds(X_START + 180, Y_START + (row++ * 50), 50, 30);
